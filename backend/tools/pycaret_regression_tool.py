"""
PyCaret Regression Tool
Automated ML for regression tasks
"""
...
class PyCaretRegressionTool(Tool):
    """
    Tool for automated regression model training using PyCaret
    """
    
    name = "pycaret_regression_training"
    description = """Trains regression models using PyCaret AutoML.
    ...
    def forward(self, input_file: str, target_column: str, output_dir: str,
        ...
        # Key Change: Sort by 'R2' for regression
        if exclude_models:
        ...
        # Generate evaluation plots for regression
        print("📊 Generating evaluation plots...")
        # Key Change: Use regression-specific plots
    ...
    def _create_summary(self, comparison_df: pd.DataFrame, 
        ...
        """Create training summary report for regression"""
...
"""
        # Key Change: Extract key regression metrics from final results
        if not metrics_df.empty:
            for col in ['R2', 'RMSE', 'MAE', 'MSE']:
